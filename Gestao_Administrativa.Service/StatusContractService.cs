...
{
    public class StatusContractService : BaseService<StatusContractModel, int?>, IStatusContractService
    {
        public StatusContractService(SubscriptionManagementDBContext db) : base(db)
        {
        }
    }
}
