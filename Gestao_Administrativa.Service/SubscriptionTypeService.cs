...
{
    public class SubscriptionTypeService : BaseService<SubscriptionTypeModel, int?>, ISubscriptionTypeService
    {
        public SubscriptionTypeService(SubscriptionManagementDBContext db) : base(db)
        {
        }
    }
}
