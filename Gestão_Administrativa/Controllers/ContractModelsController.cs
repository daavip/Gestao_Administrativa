...
namespace Gestao_Administrativa.API.Controllers
{
    //[Route("[controller]")]
    //[ApiController]
    //public class ContractController : BaseController<ContractModel, int?>
    //{
    //    public ContractController(IContractService service, ILogger<ContractController> loger) : base(service, loger)
    //    {
    //    }
